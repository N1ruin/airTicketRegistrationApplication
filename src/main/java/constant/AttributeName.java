...
public class AttributeName {
    ...
    public static final String HTTP_HELPER = "httpHelper";
    ...
    public static final String CREATE_AIRPORT_RESPONSE_CONVERTER = "createAirportResponseConverter";
    public static final String AIRPORT_VALIDATION_SERVICE = "airportValidationService";
    public static final String UPDATE_AIRPORT_REQUEST_CONVERTER = "updateAirportRequestConverter";
    public static final String UPDATE_AIRPORT_RESPONSE_CONVERTER = "updateAirportResponseConverter";
    public static final String AIRPORT_CONVERTER = "airportConverter`";

    public static final String ADDRESS_VALIDATION_SERVICE = "addressValidationService";
    ...
    public static final String CREATE_PASSENGER_RESPONSE_CONVERTER = "createPassengerResponseConverter";
    ...
    public static final String UPDATE_PASSENGER_RESPONSE_CONVERTER = "updatePassengerResponseConverter";

    public static final String PASSPORT_VALIDATION_SERVICE = "passportValidationService";
    ...
    public static final String CREATE_FLIGHT_RESPONSE_CONVERTER = "createFlightResponseConverter";
    public static final String FLIGHT_CONVERTER = "flightDtoConverter";
    public static final String FLIGHT_VALIDATION_SERVICE = "flightValidationService";
    public static final String UPDATE_FLIGHT_REQUEST_CONVERTER = "updateFlightRequestConverter";
    public static final String UPDATE_FLIGHT_RESPONSE_CONVERTER = "updateFlightResponseConverter";
    public static final String FLIGHT_SERVICE = "flightService";


    public static final String TICKET_SERVICE = "ticketService";
    public static final String TICKET_VALIDATION_SERVICE = "ticketValidationService";
    public static final String CREATE_TICKET_REQUEST_CONVERTER = "createTicketRequestConverter";
    public static final String CREATE_TICKET_RESPONSE_CONVERTER = "createTicketResponseConverter";
